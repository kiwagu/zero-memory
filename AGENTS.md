...
All rules live in `.cursor/rules/` (single source of truth for Cursor and Codex).

## Always-on conventions

@.cursor/rules/zm-knowledge-first.mdc
@.cursor/rules/execute-dont-delegate.mdc
@.cursor/rules/reset-mode-default.mdc
@.cursor/rules/release-approval-flow.mdc
...
@.cursor/rules/docs-lockstep.mdc
...
@.cursor/rules/rls-policy-authoring-basics.mdc
@.cursor/rules/rls-helper-functions-and-jwt.mdc
@.cursor/rules/rls-performance-patterns.mdc
@.cursor/rules/use-realtime.mdc
@.cursor/rules/realtime-topology-and-client-patterns.mdc
@.cursor/rules/realtime-database-broadcast-and-authorization.mdc
@.cursor/rules/realtime-operations-and-migration.mdc
